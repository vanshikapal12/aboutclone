...
export default function StandardsTabs() {
  return (
    <main className="min-h-screen p-4 md:p-6 lg:p-8">
      ...
      <div className="text-center px-4 md:px-6 mb-8 md:mb-16 mt-10 md:mt-20 z-10">
        ...
        <p className="text-muted-foreground text-sm md:text-base max-w-xs sm:max-w-lg md:max-w-2xl mx-auto mb-6 md:mb-8">
          Driven by vision, we provide comprehensive solutions to meet all your
          hiring needs.
        </p>
      </div>
      ...
      <div className="container mx-auto px-4  ">
        <Tabs defaultValue="ambition" className="w-full ">
          <TabsList className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-8  h-15 rounded-full w-full max-w-3xl mx-auto dark:bg-gray-900">
            <TabsTrigger
              value="ambition"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center">
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="text-muted-foreground text-sm md:text-base">
                      ...
                      approaches and cutting-edge solutions. Our ambition drives
                      us to create transformative recruitment experiences.
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center">
                  ...
                  <div className="flex justify-center md:justify-end mt-6 md:mt-0">
                    <div className="relative w-full max-w-md aspect-video overflow-hidden rounded-lg">
                      <Image
                        src="/some1.avif" // Replace with the correct path if necessary
                  ...
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-xs md:text-sm">
                          Continuously refine processes for optimal performance
                        </span>
                      </div>
                    </div>
                  </div>
